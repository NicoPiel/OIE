...
import com.mirth.connect.connectors.jms.JmsConnectorPropertiesMap;
...
public interface JmsConnectorServletInterface extends BaseServletInterface {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = MediaType.APPLICATION_XML, schema = @Schema(implementation = JmsConnectorPropertiesMap.class), examples = {
                                                        @ExampleObject(name = "jms_connector_properties_map", ref = "../apiexamples/jms_connector_properties_map_xml") }),
                                        @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = JmsConnectorPropertiesMap.class), examples = {
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", content = {
                                        @Content(mediaType = MediaType.APPLICATION_XML, schema = @Schema(implementation = JmsConnectorProperties.class), examples = {
                                                        @ExampleObject(name = "jms_connector_properties", ref = "../apiexamples/jms_connector_properties_xml") }),
                                        @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = JmsConnectorProperties.class), examples = {
        ...
        public JmsConnectorProperties getTemplate(
    ...
    // @formatter:on
        ...
        @MirthOperation(name = "saveTemplate", display = "Save JMS Template", type = ExecuteType.ASYNC, auditable = false)
        public Set<String> deleteTemplate(
                        @Param("templateName") @Parameter(description = "The name of the template.", required = true) @PathParam("templateName") String templateName)
                        throws ClientException;
}
